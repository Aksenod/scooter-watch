...
const mockReports = [
  {
    ...
    rewardAmount: 200,
    evidence: [{ id: 'ev_1', type: 'photo' as const, url: 'https://placehold.co/600x400?text=Violation+Photo' }],
  },
  {
    id: 'report_2',
    ...
    evidence: [{ id: 'ev_2', type: 'photo' as const, url: 'https://placehold.co/600x400?text=Parking+Violation' }],
  },
  {
    id: 'report_3',
    ...
    evidence: [{ id: 'ev_3', type: 'photo' as const, url: 'https://placehold.co/600x400?text=Traffic+Violation' }],
  },
];
